const en = {
    translation: {
        ...
        footer: {
            ...
            aiClients: 'Connect your AI assistant',
            ...
            aiCopy: 'Copy',
            aiDocsLink: 'Docs',
            howClaude: 'Settings → Connectors → Add custom connector → paste URL. Free plan: 1 connector. Pro/Max: unlimited.',
            howChatGPT: 'Enable Developer Mode in Settings → Apps & Connectors → Add connector → paste URL. Requires Pro, Team or Enterprise.',
            howGrok: 'Supports remote MCP tools natively. See xAI docs for configuration.',
            howCursor: 'Settings → Developer → Edit MCP Config → add server with URL. Use mcp-remote for HTTP servers.',
            howClaudeCode: 'Run: claude mcp add vw-lt-wiring --transport http https://vw-lt-mcp.vercel.app/mcp',
        },
    },
} as const;
